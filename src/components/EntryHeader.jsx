...
export default function EntryHeader() {
  ...
  return (
    <div className="sticky top-0 z-10 border-b border-slate-200 dark:border-slate-700 bg-white/95 dark:bg-slate-900/95 backdrop-blur px-4 md:px-6 pb-3 pt-4">
      ...
      <div className="mt-2.5 flex items-center justify-between rounded-xl bg-slate-100 dark:bg-slate-800 px-3 py-2">
        <div className="relative">
          ...
          >
            <div className="text-xs text-slate-500 dark:text-slate-400">Quarter</div>
            <div className="font-bold text-slate-900 dark:text-slate-100 text-base flex items-center gap-1">
              {quarter}
          ...
          {qOpen && (
            <div className="absolute top-full left-0 mt-1 z-20 rounded-xl bg-white dark:bg-slate-800 shadow-lg ring-1 ring-slate-200 dark:ring-slate-700 py-1 min-w-[72px]">
              {quarters.map((q) => (
                <button
                  key={q}
                  type="button"
                  ...
                  className={cn(
                    ...
                    q === quarter ? 'bg-violet-50 text-violet-700 dark:bg-violet-900/30 dark:text-violet-300' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700'
                  )}
                >
                  {q}
                </button>
        ...
        <div className="text-right">
          ...
          <div className="font-bold text-slate-900 dark:text-slate-100 text-base">{gameInfo.opponent}</div>
        </div>
        <div className={cn(
